...
function Login() {
  ...
  return (
    <div className="flex items-center justify-center md:w-full md:mx-0 my-10 w-[90%] mx-auto">
      <div
        className={`mx-auto w-full max-w-lg  border-2 shadow-[0px_0px_25px_cyan,0px_0px_25px_white] shadow-cyan-400/40 border-white rounded-xl p-10 border border-black/10`}
      >
        <div className="mb-2 flex justify-center">
          <span className="inline-block w-full text-cyan-400 max-w-[100px] text-xl  font-semibold space-y-2">
        ...
        <p className="mt-2 text-center sm:text-base text-black/60 text-sm">
